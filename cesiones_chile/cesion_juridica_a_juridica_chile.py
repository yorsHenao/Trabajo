...
def generar_cesion_juridica_a_juridica_chile():
    #ruta
    plantilla = Path("Plantillas/chile/formato_cesión_moral_a_moral_chile.docx")

    print(f"\n{"*"*10}Cesión Persona jurídica a Persona jurídica{"*"*10}\n")
