...
def generar_cesion_juridica_a_fisica_arg():
    #ruta
    plantilla = Path("plantillas/argentina/acta_cesion_juridica_fisica_arg.docx")

#palabras a rellenar

    print(f"\n{"*"*10}Cesión Personas juridica a fisica{"*"*10}\n")
