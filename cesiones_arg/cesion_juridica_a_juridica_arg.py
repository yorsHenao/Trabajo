...
def generar_cesion_juridica_a_juridica_arg():
    #ruta
    plantilla = Path("plantillas/argentina/acta_cesion_juridica_juridica_arg.docx")

#palabras a rellenar

    print(f"\n{"*"*10}Cesión Personas juridica a juridica{"*"*10}\n")


    #cedente
    nombre_cedente = input("Ingrese razón social cedente: ")
    rl_cedente = input("Ingrese nombre representante rz cedente: ")
    cuit_cedente = input("Ingrese Cuit razón social cedente: ")
    ...
    cuit_cesionario = input("Ingrese cuit razón social cesionario: ")
