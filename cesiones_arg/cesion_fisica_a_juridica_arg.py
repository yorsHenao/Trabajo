...
def generar_cesion_fisica_a_juridica_arg():
    #ruta
    plantilla = Path("plantillas/argentina/acta_cesion_natural_juridica_arg.docx")

#palabras a rellenar

    print(f"\n{"*"*10}Acta Cesión Personas fisica a juridica{"*"*10}\n")
