...
def generar_anexo_juridico_arg():
    #ruta
    plantilla = Path("plantillas/argentina/Anexo_de_Adhesión_Juridica_arg.docx")

#palabras a rellenar

    print(f"\n{"*"*10}Anexo adhesión ARGENTINA{"*"*10}\n")


    #Aliado
    aliado = input("Ingrese razón social a anexar: ")
    rl_aliado = input("Ingrese representante legal: ")
